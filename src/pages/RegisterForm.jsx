          ...
          <form>
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setPasswordCnrf(e.target.value)}
                />
              </div>
            ...
            <div className="mt-12">
              <button
                onClick={singUp}
                type="button"
                className="w-full py-3 px-4 text-sm tracking-wider font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none cursor-pointer"
              >
                Create an account
              </button>
            </div>
