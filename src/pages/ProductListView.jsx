      ...
      <div className=" bg-gray-100 flex gap-7 items-center p-2 roundrd-md">
        ...
        <div className=" space-y-2">
          ...
          <p className="font-semibold flex items-center md:text-lg text-sm">
            <span className="md:text-4xl text-3xl text-red-500">
              <span className="font-semibold text-2xl text-black">$</span>
              {product.price}
            </span>
            ({product.discount}% off)
          </p>
          <p className=" text-sm">
            FREE delivery by <span className="font-semibold">Fri,18 Dec</span>{" "}
            <br />
            or fastest delivery by{" "}
            <span className="font-semibold">Tomorrow,17 Dec</span>
          </p>
          <button
