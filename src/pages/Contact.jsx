      ...
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-10 w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="text-white space-y-6">
            ...
            <div>
              <p><strong>📍 Address:</strong> 123 Jadavpur,Kolkata 700036</p>
              <p><strong>📧 Email:</strong> hydrivaofficial@gmail.com</p>
              <p><strong>📞 Phone:</strong> +91 6289168373</p>
            </div>
          </div>
          ...
          <form className="space-y-6">
            ...
            <button type="submit" className="w-full cursor-pointer bg-gradient-to-r from-red-500 to-purple-500 text-white font-semibold py-2 rounded-xl hover:opacity-90 transition-all duration-300">
              Send Message 🚀
            </button>
          </form>
        </div>
