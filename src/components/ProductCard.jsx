...
const ProductCard = ({product}) => {
    ...
    const imgSrc = Array.isArray(product?.images) && product.images?.[0]?.url ? product.images?.[0]?.url : ""
  ...
  return (
    ...
    hover:shawod-2xl transition-all p-2 h-max'>
      <img src={imgSrc} alt="" className=' bg-gray-100 aspect-square' onClick={()=>navigate(`/products/${product.slug}`)}/>
