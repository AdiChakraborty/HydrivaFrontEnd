...
export default function MyAddresses() {
  ...
  const submitAddress = () =>{
    ...
    if(addresses.length ===0){
     ...
     axiosInstance.post(`/addresses`, form).then(res=>console.log(res.data))
    ...
    <>
      <div className="px-5 mx-auto">
        ...
        <div className="flex justify-between mb-6 mt-6">
          ...
          <button className="text-lg px-6 py-2 bg-black text-white rounded-md cursor-pointer">+ Add Address</button>
        </div>
